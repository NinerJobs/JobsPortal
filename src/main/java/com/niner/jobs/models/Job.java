...
//	}
//	private List<Location> locations;
//	public Job(String title, String description, Recruiter recruiter, Date postedDate, Date closingDate, int vacancies,
//			List<Location> locations) {
//		super();
//		this.title = title;
//		this.description = description;
...
//	@Override
//	public String toString() {
//		return "Job [id=" + id + ", title=" + title + ", description=" + description + ", recruiter=" + recruiter
//				+ ", postedDate=" + postedDate + ", closingDate=" + closingDate + ", vacancies=" + vacancies
//				+ ", locations=" + locations + "]";
//	}
//	
//	
